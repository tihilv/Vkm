...
namespace Vkm.Library.Config
{
    class LibraryConfig: IConfigurator
    {
        ...
        public void Configure(IOptionsService optionsService)
        {
            ...
            Identifier DefaultAudioSessionsLayout = new Identifier("Vkm.AudioSessions.Default");
            ...
            //GlobalOptions.LayoutLoadOptions.InitializationInfos.Add(new ModuleInitializationInfo(AudioSessionsLayoutFactory.Identifier, DefaultAudioSessionsLayout));
