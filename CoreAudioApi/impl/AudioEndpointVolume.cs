...
namespace CoreAudioApi
{
    ...
    public class AudioEndpointVolume : IDisposable
    {
        ...
        private event EventHandler<VolumeNotificationEventArgs> _OnVolumeNotification;
        public event EventHandler<VolumeNotificationEventArgs> OnVolumeNotification
        {
            add { _OnVolumeNotification += value; }
            remove { _OnVolumeNotification -= value; }
        }
    ...
    public class VolumeNotificationEventArgs : EventArgs
    {
        private readonly AudioVolumeNotificationData _data;
        public AudioVolumeNotificationData NotificationData { get { return _data; } }
